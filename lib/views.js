...
<span id="share" class="mdl-chip mdl-chip--contact">
    <span class="mdl-chip__contact mdl-color-text--white material-icons"  style="  color: linear-gradient(right, #232526, #414345); ">person_add</span>
    <span class="mdl-chip__text">Add Friend('s)</span>
</span>
`
...
<div class=" mdl-card mdl-shadow--2dp card" id="a${item => item.key}">
  ...
  <div class="mdl-textfield mdl-js-textfield">
     <textaera contenteditable="true"  rows="1" id="s"  class=" mdl-textfield__input header person-name">${item => item.username}</textaera>
  </div>
...
<div class="card">
  ...
  <div class="extra content">
    ...
    <div class="volume">
      ...
      <p class="range-field">
        <input id="id_field5" type="range" min="0" max="2" step=".05"  name="field5" type="range" class="active"><span class="thumb" style="left: 113.984px; height: 0px; width: 0px; top: 10px; margin-left: -6px;"><span class="value">19</span></span></p>
    </div>
  </div>
</div>
`
...
<div id="settings" class="ui modal">
    ...
    <div class="header"><span class="mdl-chip">
    <span class="mdl-chip__text">Settings</span>
</span></div>
